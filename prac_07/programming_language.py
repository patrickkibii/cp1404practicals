...
def run_tests():
    ...
    ruby = ProgrammingLanguage("Ruby", "Dynamic", True, "Yes", 1995, )
    python = ProgrammingLanguage("Python", "Dynamic", True, "Yes", 1991)
    visual_basic = ProgrammingLanguage("Visual Basic", "Static", False, "Yes", 1991)
